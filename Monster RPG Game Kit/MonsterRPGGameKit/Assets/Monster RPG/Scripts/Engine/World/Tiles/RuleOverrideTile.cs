...
{
	[HelpURL(MonsterRpg.DocumentationUrl + "rule-override-tile")]
	[CreateAssetMenu(fileName = nameof(RuleOverrideTile), menuName = "PiRho Soft/Tiles/Rule Override Tile", order = 109)]
