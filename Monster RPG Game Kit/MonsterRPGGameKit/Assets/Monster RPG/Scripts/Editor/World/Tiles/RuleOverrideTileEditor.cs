...
namespace PiRhoSoft.MonsterRpgEditor
{
	...
	{
		private static readonly IconButton _createRulesIcon = new IconButton(IconButton.Edit, "Set the sprite for each rule for each sprite in the default tile's sprite sheet");
