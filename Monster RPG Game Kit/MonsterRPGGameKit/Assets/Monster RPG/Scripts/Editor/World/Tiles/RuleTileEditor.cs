...
namespace PiRhoSoft.MonsterRpgEditor
{
	...
	{
		private static readonly IconButton _createRulesButton = new IconButton(IconButton.Edit, "Create or set a rule for each sprite in the default tile's sprite sheet");
		private static readonly IconButton _addRuleButton = new IconButton(IconButton.Add, "Add a rule to the list");
		private static readonly IconButton _removeRuleButton = new IconButton(IconButton.Remove, "Remove this rule");
		private static readonly IconButton _addNeighborTypeButton = new IconButton(IconButton.Add, "Add a neightbor type to the list");
		private static readonly IconButton _removeNeightborTypeButton = new IconButton(IconButton.Remove, "Remove this neighbor type");
		...
		private void DrawDefaultRule()
		{
			...
			{
				_ruleTile.DefaultRule.Tile = TileTransformInfoControl.Draw(GUIContent.none, _ruleTile.DefaultRule.Tile);
				_ruleTile.DefaultRule.Reference = null;
			}
		}
