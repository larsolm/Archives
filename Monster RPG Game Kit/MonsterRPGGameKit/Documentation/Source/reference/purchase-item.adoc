[#reference/purchase-item]

## PurchaseItem

PiRhoSoft.MonsterRpgEngine.PurchaseItem : link:/projects/unity-composition/documentation/#/v10/reference/instruction-graph-node[InstructionGraphNode^]
