[#reference/thaw-controller]

## ThawController

PiRhoSoft.MonsterRpgEngine.ThawController : link:/projects/unity-composition/documentation/#/v10/reference/instruction-graph-node[InstructionGraphNode^]
