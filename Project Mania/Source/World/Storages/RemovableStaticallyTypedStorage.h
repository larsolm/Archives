...
class RemovableStaticallyTypedStorage
{
public:
	RemovableStaticallyTypedStorage();
...
template<typename Type>
RemovableStaticallyTypedStorage<Type>::RemovableStaticallyTypedStorage()
{
...
template<typename Type>
auto RemovableStaticallyTypedStorage<Type>::All() const -> SequenceView<std::unique_ptr<Type>>
{
...
auto RemovableStaticallyTypedStorage<Type>::Create(Args&&... args) -> Type*
{
...
template<typename Type>
auto RemovableStaticallyTypedStorage<Type>::Lookup(typename Type::IdType id) -> Type*
{
...
template<typename Type>
void RemovableStaticallyTypedStorage<Type>::Destroy(typename Type::IdType id)
{
	auto index = id._id & LookupMask;
	auto& entry = _indices.Item(index);
